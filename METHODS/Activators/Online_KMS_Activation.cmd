...
::============================================================================
::
::   Branded fork: RK (Root Kernel) - Dev Tej
::
::============================================================================
...
color 07
set KS=K%blank%MS
title  %rkname% - Online %KS% Activation %masver%
...
echo:
echo   This Script is part of the RK project by %rkdev%.
echo:   
echo   Upstream project: mass%w%grave%w%.dev
)>"%_dest%\Info.txt"
exit /b
